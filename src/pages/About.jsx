        ...
        <main>
          <div className="flex flex-col items-center justify-between md:flex-row w-full max-w-[65rem] mx-auto p-6 gap-4 sm:gap-12 sm:mt-16 ">
            <div className="flex flex-col gap-8">
              <h1 className="mt-8 text-3xl underline sm:text-5xl decoration-bright-blue underline-offset-4">
                About <span className="font-bold text-gradient ">Tamareen</span>
              </h1>
              <p className="text-xl font-medium leading-relaxed tracking-wide sm:text-2xl">
            ...
            <div>
              <div className="w-[17rem] h-[17rem] sm:w-[25rem] sm:h-[25rem] flex justify-center items-center mt-6  ">
